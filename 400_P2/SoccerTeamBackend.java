...
public class SoccerTeamBackend implements ISoccerTeamBackend{
	private IterableRBTree dataBase;
	 ...
	 * constructor
	 */
	public SoccerTeamBackend() { // initializes the fields to default values
		dataBase = new IterableRBTree();
	    ratingFilterLB = null;
	    ratingFilterUB = null;
	    MVFilterLB = null;
	    MVFilterUB = null;
	...
	public List<IPlayer> ListPlayers() {
		...
		if(ratingFilterLB == null)
			ratingFilterLB = -999999999;
		if(ratingFilterUB== null)
			ratingFilterUB = 999999999;
		if(MVFilterLB== null)
			MVFilterLB = -999999999;
		if(MVFilterUB== null)
			MVFilterUB = 999999999;
		dataBase.iterator();
	...
	public static void main(String[] args) {
		...
		System.out.println(test.getNumberOfPlayers());
	}
}